...
const Gadget = () => {
  ...
  const men = data?.filter((dt) => dt.category === "gadget");
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-12 md:col-span-9 p-5 md:p-0">
            <div className="grid grid-cols-12 gap-5 mt-10">
              {men && men.length === 0 ? (
                <p className="col-span-12 text-center text-gray-500 text-lg">
                  No product found
                </p>
              ) : (
                /* card */
...
export default dynamic(() => Promise.resolve(Gadget), { ssr: false });
