  ...
  return (
    <div className="max-w-[1300px] mx-auto">
      ...
      <div className="flex gap-3 mt-7">
        {/* first category */}
        <div>
          <Image src={category1} alt="category1" height={600}></Image>
          <h5 className="text-2xl font-semibold text-center mt-5">
            Spring Forward!
          </h5>
          <div className="flex justify-center">
            <button className="mt-3 border border-[#333333] text-[#333333] py-3 px-7 rounded-md text-sm uppercase ">
              Discover More
            </button>
          </div>
        </div>
        {/* second category */}
        <div>
          <Image src={category2} alt="category1" height={600}></Image>
          <h5 className="text-2xl font-semibold text-center mt-5">
            Bold Moves
          </h5>
          <div className="flex justify-center">
        ...
        {/* third category */}
        <div>
          <Image src={category3} alt="category1" height={600}></Image>
          <h5 className="text-2xl font-semibold text-center mt-5">
            Online Exclusive
          </h5>
          <div className="flex justify-center">
